...
<Header
  title="Enabling Behavioral Diversity for Learning Locomotion in Humanoid Robots"
  conference="Conference Name"
  authors={[
    {
      name: "Author Names Omitted for Anonymous Review. Paper-ID [716]",
  ...
  links={[
    ...
    { name: "Code", url: "./code", icon: "ri:github-line" },
    { name: "Supplementary", url: "./supplementary/DLDL_supplementary.pdf", icon: "ri:file-pdf-2-line" },
